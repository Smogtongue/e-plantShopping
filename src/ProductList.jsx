...
function ProductList({ onHomeClick }) {
    ...
    const totalQuantity = useSelector(selectTotalQuantity); // Retrieve total quantity from Redux store
    ...
    }, [cartItems]); // Re-run effect when cart items change
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)} style={{ pointerEvents: 'auto' }}>
                            <div>
                        ...
                        <div className="cart-icon-container">
                            ...
                            {totalQuantity > 0 && (
                                <span 
                                    ...
                                    data-length={totalQuantity.toString().length} /* Add data attribute for digit length */
                                >
                                    {totalQuantity}
                                </span>
                            )}
                    ...
                    <div key={index}>
                        ...
                        <div className="product-list">
                            ...
                            <div className="product-card" key={plantIndex}>
                                {plant.isOnSale && <div className="sale-tag">SALE</div>} {/* Add SALE tag conditionally */}
